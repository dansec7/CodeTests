/* This file is not meant to be taken seriously. As a joke, I wanted to write the vast majority of it in just main().
   For really annoying stuff I will have methods such as getRandom() so I don't have to write that line of code a 
   million times. getBattle() is a work in progress towards the bottom which will be able to replace the currently 
   very elongated battle scripting. 
   ...
   for me to wrap my head around some stuff in specific ways. */
